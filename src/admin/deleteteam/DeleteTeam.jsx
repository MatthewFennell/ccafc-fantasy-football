...
const mapStateToProps = state => ({
    ...
    deleteTeamError: selectors.getDeleteTeamError(state),
    deleteTeamErrorCode: selectors.getDeleteTeamErrorCode(state),
    deletingTeam: selectors.getDeletingTeam(state)
});
