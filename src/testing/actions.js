...
export const FETCH_WEEKLY_TEAMS = `${pre}FETCH_WEEKLY_TEAMS`;
export const FETCH_WEEKLY_TEAMS_SUCCESS = `${pre}FETCH_WEEKLY_TEAMS_SUCCESS`;
export const FETCH_WEEKLY_TEAMS_ERROR = `${pre}FETCH_WEEKLY_TEAMS_ERROR`;
