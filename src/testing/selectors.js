...
export const getLeagueIAmIn = state => state.testing.myLeagues;
export const getAllLeagues = state => state.testing.allLeagues;
...
export const getAllTeams = state => state.testing.allTeams;
